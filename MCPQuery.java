...
public class MCPQuery {
  ...
  private void run() {
    ...
    try {
        ...
        while (true) {
          ...
          if(match.find()) {
            ...
            if (match2.find()) {
              ...
              display.append("An error has occured, please exit.\nDid the website format change? \nDid you remember the trailing slash at the end of the multicraft root link?");
              break;
            }
          } else {
            display.append("An error has occured, please exit.\nDid you enter invalid credentials? Did the website format change? \nDid you remember the trailing slash at the end of the multicraft root link?");
            break;
          }
      ...
      display.append("An error has occured, please exit. \nDid you enter invalid credentials? Did the website format change? \nDid you remember the trailing slash at the end of the multicraft root link? \nIf you need more help, email pandemic@moon-network.net this:\n" + a);
    }
  }
